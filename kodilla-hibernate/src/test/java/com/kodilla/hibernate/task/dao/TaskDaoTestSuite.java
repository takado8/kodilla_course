...
class TaskDaoTestSuite {
    ...
    void testTaskListFindByListName(){
        ...
        //than
        var result = taskListDao.findByListName(NAME);
        assertFalse(result.isEmpty());
        System.out.println(result.get(0));
        //cleanup
        taskListDao.delete(result.get(0));
    }
    ...
    void testNamedQueries() {
        ...
        List<Task> timeGreaterThan6 = taskDao.retrieveTasksWithDurationLongerThan(6);
        ...
        try {
            ...
            assertEquals(2, timeGreaterThan6.size());
        } finally {
            //CleanUp
